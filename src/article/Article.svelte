  ...
  <div id="description">
    ...
    <div class="article-section">
      ...
      <p>
        ...
        <a href="https://dl.acm.org/doi/10.5555/3295222.3295349" title="ACM Digital Library" target='_blank'>"Attention is All You Need"</a>
        ...
        <a href="https://huggingface.co/learn/audio-course/en/chapter3/introduction" title='Hugging Face' target='_blank'>audio generation</a>,
        <a href="https://huggingface.co/learn/computer-vision-course/unit3/vision-transformers/vision-transformers-for-image-classification" title='Hugging Face' target='_blank'>image recognition</a>,
        <a href="https://elifesciences.org/articles/82819" title='eLife'>protein structure prediction</a>,
        and even <a href="https://www.deeplearning.ai/the-batch/reinforcement-learning-plus-transformers-equals-efficiency/" title='Deep Learning AI' target='_blank'>game playing</a>,
      ...
      <p>
        ...
        <a href="https://huggingface.co/openai-community/gpt2" title='Hugging Face' target='_blank'>GPT-2</a>
    ...
    <div class="article-section">
      ...
      <div class="architecture-section">
        ...
        <div class="figure-caption">
          ...
          The process involves <span class='fig-numbering'>(1)</span> Tokenization, (2) Token Embedding, (3) Positional Encoding, and (4) Final Embedding.
        </div>
        <div class="article-subsection">
          ...
          <p>
            ...
            These tokens can be a word or a subword. The words <code>"Data"</code>
            and <code>"vizualization"</code> corresponds to unique tokens,
            while the word <code>"empowers"</code> is split into two tokens.

            The full vocabulary of tokens is decided before training the model:
            GPT-2's vocabulary has <code>50,257</code> unique tokens.
        ...
        <div class="article-subsection">
          ...
          <p>
            GPT-2 Small represents each token in the vocabulary as a 768-dimensional
            vector; the dimension of the vector
            depends on the model.

            These embedding vectors are stored in a matrix of shape <code>(50,257, 768)</code>,
        ...
        <div class="article-subsection">
          ...
          <p>
            ...
            and their position in the input sequence.
          </p>
        </div>
      </div>
      ...
      <div class="architecture-section">
        ...
        <div class="article-subsection">
          ...
          <div class="article-subsection-l2">
            ...
            <div class="figure-caption">
              Figure <span class='attention'>X</span>. Computing Query, Key, and Value matrices from the original embedding.
            </div>
            ...
            <ul>
              <li>
                <strong class="q-color font-medium">Query (Q)</strong> is the search text you type in the search engine bar. This is the token you want to <em>"find more information about"</em>.
              </li>
              <li>
                <strong class="k-color font-medium">Key (K)</strong> is the title of each web page in the search resul window. It represents the possible tokens the query can attend to.
              </li>
              <li>
          ...
          <div class="article-subsection-l2">
            ...
            <div class="figure-caption">
              Figure <span class='attention'>X</span>. Using Query, Key, and Value matrices to calculate masked self-attention.
            </div>

            <ul>
              <li>
                <strong>Attention Score</strong>: The dot product of <span class='q-color'>Query</span>
                and <span class='k-color'>Key</span> matrices determines the alignment
                of each query with each key, producing a square matrix that reflects
                the relationship between all input tokens.
              </li>
              <li>
              ...
              <li>
                ...
                every other token to the left of it.
              </li>
            </ul>
          </div>
          <div class="article-subsection-l2">
            ...
            <p>
              ...
              <span class="v-color">Value</span> matrix to get the <span class='purple-color'>final output</span>
              of the self-attention mechanism.

              GPT-2 has <code>12</code> self-attention heads, each capturing different
              relationships between tokens. The outputs of these heads are concatenated
              and passed through a linear projection.
            </p>
        </div>
        ...
        <div class="article-subsection">
          <h3>MLP: Multi-Layer Perceptron</h3>
            ...
            <div class="figure-caption">
              Figure <span class='attention'>X</span>. Using MLP layer to project
              the self-attention representations into higher dimensions to enhance the model's representational capacity.
            </div>
          ...
          <p>
            ...
            input four-fold from <code>768</code> to <code>3072</code>.

            The second linear transformation reduces the dimensionality back to
            the original size of <code>768</code>,
            ...
            simply maps them from one representation to another.
          </p>
        </div>
      ...
      <div class="architecture-section">
        ...
        <p>
          ...
          This layer projects the final representations into a <code>50,257</code>
          dimensional space, where every token in the vocabulary has a corresponding
          value called <code>logit</code>. Any token can be the next word, so this
        ...
        <div class="figure-caption">
          Figure <span class='attention'>X</span>. Each token in the vocabulary is assigned a probability based on the model's output logits.
          These probabilities determine the likelihood of each token being the next word in the sequence.
        </div>

        <p>
          The final step is to generate the next token by sampling from this distribution

          The <code>temperature</code> hyperparameter plays a critical role in this process.

          Mathematically speaking, it is a very simple operation:
          model output logits are simply divided by the <code>temperature</code>:
        </p>
        ...
        <ul>
          ...
          <li>
            <code>temperature &lt; 1</code>: Lower temperature makes the model more confident and deterministic
        by sharpening the probability distribution, leading to more predictable outputs.
          </li>
          <li>
            <code>temperature &gt; 1</code>: Higher temperature creates a softer probability distribution,
        allowing for more randomness in the generated text – what some refer to as model <em>“creativity”</em>.
          </li>
        </ul>
      ...
      <div class="architecture-section">
        ...
        <p>
          ...
          Residual Connections allows gradients to flow directly through the network and helps to prevent the vanishing gradient problem.
        </p>
        <div class="article-subsection">
        ...
        <div class="article-subsection">
          ...
          <p>
            ...
            which leads to a better model performance.
    ...
    <div class="article-section">
      ...
      <p>
        Transformer Explainer is built to be interactive and allow you to explore the inner workings of the Transformer.
        Here are some of the interactive features you can play with:
      </p>

      <ul>
        <li>
          <strong>Input your own text sequence</strong> to see how the model processes it and predicts the next word.

          Explore attention weights, intermediate computations, and see how the final output probabilities are calculated.
        </li>
        <li>
          <strong>Use the temperature slider</strong> to control the randomness of the model’s predictions.

          Explore how you can make the model output more deterministic or more creative by changing the temperature value.
        </li>
        <li>
          <strong>Interact with attention maps</strong> to see how the model
    ...
    <div class="article-section">
      ...
      <p>
        ...
        <a href="https://github.com/karpathy/nanoGPT" title='Github'  target='_blank'>nanoGPT project</a>
        and has been converted to <a href="https://onnxruntime.ai/" title='ONNX'  target='_blank'>ONNX Runtime</a>
        for seamless in-browser execution.

        The interface is built using JavaScript, with <a href="https://kit.svelte.dev/" title='Svelte'  target='_blank'>Svelte</a>
        as a front-end framework and <a href="http://D3.js" title='D3'  target='_blank'>D3.js</a>
